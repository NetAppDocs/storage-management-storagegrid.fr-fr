...
* https://docs.netapp.com/us-en/console-setup-admin/media/notice.pdf["Avis concernant la console NetApp"^]
* link:media/NOTICE-storageservices.pdf["Avis concernant la gestion de la console NetApp des systèmes StorageGRID"^]
